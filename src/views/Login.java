...
public class Login extends JFrame {
	...
	public Login() {
		...
		imgHotel.setBounds(0, 32, 304, 495);
		...
		separator.setBackground(new Color(144, 238, 144));
		separator.setBounds(65, 292, 324, 2);
		panel.add(separator);
		JLabel labelTitulo = new JLabel("INICIAR SESIÓN");
		labelTitulo.setForeground(new Color(144, 238, 144));
		...
		txtContrasena.setFont(new Font("Dialog", Font.PLAIN, 14));
		...
		LabelUsuario.setFont(new Font("Dialog", Font.PLAIN, 18));
		...
		lblContrasea.setBounds(65, 320, 140, 26);

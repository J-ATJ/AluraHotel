...
public class MenuPrincipal extends JFrame {
	...
	public MenuPrincipal() {
		...
		imagenFondo.setBounds(-50, 36, 735, 465);
		...
		JLabel lblCopyR = new JLabel("Desarrollado por J-ATJ & Alura © 2022");
		lblCopyR.setHorizontalAlignment(SwingConstants.CENTER);
		lblCopyR.setBounds(265, 10, 385, 22);
		lblCopyR.setForeground(new Color(255, 255, 255));
		lblCopyR.setFont(new Font("Dialog", Font.BOLD, 18));

...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
		...
		panelMenu.setBackground(new Color(144, 238, 144));
		...
		btnRegistro.addMouseListener(new MouseAdapter() {
			...
			public void mouseExited(MouseEvent e) {
				btnRegistro.setBackground(new Color(102, 205, 170));	
			}
			@Override
		...
		btnBusqueda.addMouseListener(new MouseAdapter() {
			...
			@Override
			public void mouseExited(MouseEvent e) {
				btnBusqueda.setBackground(new Color(102, 205, 170));	
			}
			@Override
			public void mouseClicked(MouseEvent e) {
	    ...
	    panelFecha.setBackground(new Color(144, 238, 144));
	    panelFecha.setBounds(256, 84, 688, 140);
	    contentPane.add(panelFecha);
	    panelFecha.setLayout(null);
	    JLabel lblNewLabel_1 = new JLabel("Sistema de reservas Hotel Alura");
	    lblNewLabel_1.setHorizontalAlignment(SwingConstants.CENTER);
	    lblNewLabel_1.setBounds(10, 11, 668, 42);
	    ...
	    labelFecha.setBounds(20, 64, 658, 51);
	    ...
	    labelDescripcion_1.setFont(new Font("Dialog", Font.PLAIN, 17));
